                        ...
                        <div class="card-body" style="background-color:#D9D6CF">
                            <div class="row">
                                ...
                                <div class="m-auto" style="text-align: center">
                                    <button type="button" style="background-color: #E8A300" class="btn btn-sm text-white"
                            ...
                            <div class="collapse mt-5" style="color: white" id="skills{{$key}}">
                                <p style="text-align: center; background-color:rgba(255,255,255,0.1); color: #21201C"><b>Abilities</b></p>
                                        ...
                                        @if(Auth::check())
                                            @if(Auth::user()->role->name == "admin")
                                                <div class="col-md-3 m-auto" style="text-align:center">
                                                    <button style="width: 30%; background-color: #E8A300" type="button"
                                                            class="btn btn-sm"
                                                    ...
                                                    <div class="modal fade" id="skillDeleteModal{{$skill->id}}"
                                                         tabindex="-1"
                                                         role="dialog" aria-labelledby="skillDeleteModal{{$skill->id}}"
                                                         aria-hidden="true">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form class="delete mt-1"
                                                                        ...
                                                                        <input type="hidden" name="_method"
                                                                               value="DELETE">
                                                                        {{ csrf_field() }}
                                                                        <button type="submit" style="background-color: #E8A300"
                                                                                class="btn btn-sm">
                            ...
                            <div class="collapse mt-5" style="color: white" id="skins{{$key}}">
                                <p style="text-align: center; background-color:rgba(255,255,255,0.1); color: #21201C"><b>Skins</b></p>
                                        ...
                                        @if(Auth::check())
                                            @if(Auth::user()->role->name == "admin")
                                                <div class="col-md-4 m-auto">
                                                    <button style="width: 20%; background-color: #E8A300" type="button"
                                                    ...
                                                    <div class="modal fade" id="skinDeleteModal{{$skin->id}}"
                                                         tabindex="-1"
                                                         role="dialog" aria-labelledby="skinDeleteModal{{$skin->id}}"
                                                         aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
